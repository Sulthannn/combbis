...
if (isset($_POST['tambah'])) {
  if (tambah_peta($_POST) > 0) {
      echo "<script>
              alert('Data Persebaran Mangrove berhasil ditambahkan!');
              document.location.href = 'sebaran.php';
          </script>";
  } else {
     
      echo "<script>
              alert('Data Persebaran Mangrove gagal ditambahkan!');
          </script>";
  }
}
?>
...
<head>
  ...
  <title>COMBBIS | Admin-Tambah Sebaran</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tambahsebaran.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="font-size:30px;">Tambah Data Sebaran</h1>
    </div><br>
      ...
      <div class="row">
       <div class="col-lg-5">
        ...
        <div class="col-lg-7">
          ...
          <div class="card">
            <div class="card-body">
              <h1 class="card-title" style="font-size:26px;">Tambah Data</h1>
              ...
              <div class="container" data-aos="fade-up">
                    ...
                    <div class="col-md">
                        ...
                        <div class="mb-3">
                        <label for="koordinat" class="form-group">Koordinat/GeoJSON</label>
                        <textarea type="text" class="form-control w-50" id="koordinat" placeholder="" name="koordinat" rows="10 " required></textarea>
                        </div>
                        <div class="mb-3">
                        <label for="pulau" class="form-label">Pulau</label>
                        <input type="text" class="form-control w-50" id="pulau" placeholder="" name="pulau" required>
                        </div>
                        <div class="mb-3">
                        <label for="desa" class="form-label">Kecamatan</label>
                        <input type="text" class="form-control w-50" id="desa" placeholder="" name="desa" required></input>
                        </div>
                        <div class="mb-3">
                        <label for="luas" class="form-label">Luas (Ha)</label>
                        <input type="text" class="form-control w-50" id="luas" placeholder="" name="luas" required></input>
                        </div>
                        <div class="mb-3">
                        <label for="sangat" class="form-label">Sangat Sehat (Ha)</label>
                        <input type="text" class="form-control w-50" id="sangat" placeholder="" name="sangat"></input>
                        </div>
                        <div class="mb-3">
                        <label for="sehat" class="form-label">Sehat (Ha)</label>
                        <input type="text" class="form-control w-50" id="sehat" placeholder="" name="sehat"></input>
                        </div>
                        <div class="mb-3">
                        <label for="cukup" class="form-label">Cukup Sehat (Ha)</label>
                        <input type="text" class="form-control w-50" id="cukup" placeholder="" name="cukup"></input>
                        </div>
                        <div class="mb-3">
                        <label for="def" class="form-label">Deforestasi (Ha)</label>
                        <input type="text" class="form-control w-50" id="def" placeholder="" name="def"></input>
                        </div>
                        <br>
                        <hr>
                        <a href="sebaran.php" class="btn btn-info"><i class="bi bi-backspace"></i> Kembali</a>
                        <button type="submit" id="tambah" name="tambah" class="btn btn-secondary" onclick="return confirm('Apakah Yakin Tambah Data Sebaran Ini?')"><i class="bi bi-save"></i> Simpan</button>
</form>
</div>
</div>
</div>
