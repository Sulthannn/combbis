...
<head>
  ...
  <title>COMBBIS | Admin-Tambah Berita</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tambahberita.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="font-size:30px;">Tambah Data Berita</h1>
    </div><br>
            ...
            <div class="card-body">
              ...
              <div class="container" data-aos="fade-up">
                    ...
                    <div class="col-md">
                        ...
                        <input type="text" class="form-control w-50" id="judul" placeholder="" name="judul" required>
                        </div>
                        <div class="mb-3">
                        <label for="gambar" class="form-label">Gambar</label>
                        <input type="file" class="form-control w-50" id="gambar" placeholder="" name="gambar">
                        </div>
                        <div class="mb-3">
                        <label for="publikasi" class="form-label">Publikasi</label>
                        <input type="date" class="form-control w-50" id="publikasi" placeholder="" name="publikasi" required></input>
                        </div>
                        <div class="mb-3">
                        <label for="link" class="form-label">Link</label>
                        <input type="text" class="form-control w-50" id="link" placeholder="" name="link" required></input>
                        </div>
                        <div class="mb-3">
                        <label for="isi" class="form-label">Isi</label>
                        <textarea class="form-control w-50" id="my-text" placeholder="" name="isi" rows="5" style="resize:none;" maxlength="250" required></textarea>
                        ...
                        <button type="submit" name="tambahberita" class="btn btn-secondary" onclick="return confirm('Apakah Yakin Tambah Data Berita Ini?')"><i class="bi bi-save"></i> Simpan</button>
</form>
</div>
</div>
</div>
